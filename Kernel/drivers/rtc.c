...
/**  TODO: El offset solo modifica la hora, pero no actualiza en forma consistente los dias, meses y años
 **/

/** TODO: No funciona el HS_12
 **/
...
void set_base_mode(BASE_MODE base_mode){
    ...
    switch(rtc_base_mode){
        case BCD: _set_BCD_mode();
            break;
        case DECIMAL: _set_decimal_mode();
            break;
    }
}
...
void set_hs_mode(HS_MODE hs_mode){
    rtc_hs_mode = hs_mode;
    switch(rtc_hs_mode){
    case HS_24: _set_hour24_mode();
        break;
    case HS_12: _set_hour12_mode();
        break;
    default: 
    /** TODO: Agregar una excepcion para manejar este caso **/
        break;
    }
}
...
uint64_t get_hour(){
    ...
    {
        case HS_12:
        /** TODO: Arreglar el caso que se pide 12HS**/
        case HS_24:
